...
It can contain tables as well, with captions, of course, as seen in figure ref:example-table.
...
Results can contain some images as well, as seen in ref:figure-example.
